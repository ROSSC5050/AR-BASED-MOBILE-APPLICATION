...
public class threshold_temp : MonoBehaviour
{
    ...
    private async void Start()
    {
        ...
        while (true)
        {
            int angle = (int)Mathf.Lerp(0, 255, slider.value);

            string apiUrl = $"https://blynk.cloud/external/api/update?token=JHhdYSdSwcstn3ZLrJrroTD4lqHpUEAx&v3={angle}";
